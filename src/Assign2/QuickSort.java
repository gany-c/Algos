...
public class QuickSort {
	...
	public int sortAndCount(List<Integer> inList,int start, int end){
		...
		else
		{
			...
			int partIndex = endPartition (inList,start,end);
			

			retValue = retValue + sortAndCount(inList,start,partIndex-1);			
			retValue = retValue + sortAndCount(inList,partIndex,end);
	...
	private void displayArray(List<Integer> inList,int start,int end){
